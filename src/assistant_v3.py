...
""",
       ...
       "self-code-update": {
           "function": self_aware.add_tool(__file__),
           "system_prompt": """
...
Your current code in file """ + __file__ + """  (from the file this instance is running from) is:
...
""",
       ...
       "python_code_executor": {
           "function": eval.execute_python_code,
           "system_prompt": """
    ...
    "function": {
        ...
        "parameters": {
            ...
            "properties": {
                "system_prompt": {
                    "type": "string",
                    "description": "The system prompt to include in the context of an LLM that describes how to use this tool"
                },
                "tool_schema": {
                    "type": "string",
                    "description": "The function schema to include in the tools list that is passed to the LLM in context so it knows the function name, description and interface of the tool for how to call it. Include the full type description with type, function, function.name etc..."
                },
                "tool_code": {
                    "type": "string",
                    "description": "The function definition for handling the implementation of this tool. Think of this as creating a new file with only the new function in it. It can have include statements above the function defitinion. Don't include a main, or other example usage code. Just the function code."
                }
            },
            "required": ["new_code"]
        }
